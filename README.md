...
앱에는 이용 가능 여부를 확인한 작품과 시추천앱이 직접 작성한 창작시가 함께 수록되어 있습니다. 창작시는 결과 카드에 `창작시`로 표시하고, 외부 사이트로 이동하지 않는 텍스트 출처 표기를 사용합니다. 일부 작품은 현대 독자가 읽기 쉽도록 띄어쓰기와 문장부호를 정리했습니다.
